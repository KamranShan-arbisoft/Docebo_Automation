...
class FileUploadElement:
    pdf_file_upload_element = 'input[type="file"][accept=".pdf"]'
    imge_file_upload_element = 'input[type="file"][accept=".jpg,.gif,.png,.bmp,.jpeg"]'
    save_change_btn_element = 'div.action-buttons button.bg-positive-green-filled'
    input_search_channel = 'a[id="item_07"]'
    channel_name = 'input[id="search-1"]'
    search_btn = 'button[for="search-1"]'
    edit_channel_name = 'hyd-table.page-list__table>div>div:nth-child(2)>div>div:nth-child(3) a[href*=share]'
    content_tab_elm = 'div.tabs-manager>div:nth-child(1)>div:nth-child(2)'
    input_search_asset = 'input[id="search-4"]'
    input_search_btn = 'button[type="submit"]'
    asset_elm = 'div.hyd-table-body>div:nth-child(1) div.ellipsed>a'


class NewUSerSelectors:
    admin_menu = 'button[aria-label="Admin Menu"]'
    user = 'a[id="item_01"]'
    new_user_branch = 'button[aria-label="New Users/Branch"]'
    new_user = 'button[aria-label="New user"]'
    ...
    group_work = 'textarea[name="additionalField-14"]'
    ...
    preview_btn = 'div.users-rightpanel footer>basic-button:nth-child(3)>button'
    ...
    search_btn = 'button[for="search-1"]'
    confirmation_btn = 'div.users-rightpanel footer>basic-button:nth-child(1)>button'
